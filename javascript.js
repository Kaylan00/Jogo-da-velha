...
function initializeGame() {
  ...
  document.querySelector('.vezDe').innerHTML = 'Vez de: <span id="turnPlayer"></span>'
  updateTitle()
...
function handleWin(regions) {
  ...
  document.querySelector('.vezDe').innerHTML = playerName + ' venceu!'
}
...
function handleBoardClick(ev) {
  ...
  if (winRegions.length > 0) {
    ...
    document.querySelector('.vezDe').innerHTML = 'Empate!'
  }
}
